<template>
  <div>
    ...
    <el-row>
      <el-card>
        <el-row type="flex" justify="center" :gutter="2" class="lastz" ref="avrow">
          <el-col :span="10" v-show="recordLoad">
          ...
          <el-col :span="3" v-for="(item,keyx) in voices" :key="keyx" v-show="item.isshow">
            <voice-circul
              :ava="item.imgurl"
              :loader="item.isload"
            ...
            <div class="progress" ref="progress">
              <div class="progress__top">
                <div class="album-info" v-if="currentTrack">
                  <div class="album-info__name">{{ currentTrack.songname }}</div>
                  <div class="album-info__track">{{ currentTrack.songinfo }}</div>
                </div>
...
*/
  data() {
    return {
      ...
      voices: [
        // 亲和女声 affectionFV
        {
          voicetype: "affectionFV",
          info: "亲和女声",
          imgurl: require("@/assets/voice/affectionFV.jpg"),
          isshow: true,
          isload: false
        },
        // 亲和男声 friendlyMV
        {
          voicetype: "friendlyMV",
          info: "亲和男声",
          imgurl: require("@/assets/voice/friendlyMV.jpg"),
          isshow: true,
          isload: false
        },
        // 成熟男声 matureMV
        {
          voicetype: "matureMV",
          info: "成熟男声",
          imgurl: require("@/assets/voice/matureMV.jpg"),
          isshow: true,
          isload: false
        },
        //活力男声 energeticMV
        {
          voicetype: "energeticMV",
          info: "活力男声",
          imgurl: require("@/assets/voice/energeticMV.jpg"),
          isshow: true,
          isload: false
        },
        // 温暖女声 warmFV
        {
          voicetype: "warmFV",
          info: "温暖女声",
          imgurl: require("@/assets/voice/warmFV.jpg"),
          isshow: true,
          isload: false
        },
        // 情感女声 emotionalFV
        {
          voicetype: "emotionalFV",
          info: "情感女声",
          imgurl: require("@/assets/voice/emotionalFV.jpg"),
          isshow: true,
          isload: false
        },
        // 情感男声 emotionalMV
        {
          voicetype: "emotionalMV",
          info: "情感男声",
          imgurl: require("@/assets/voice/emotionalMV.jpg"),
          isshow: true,
          isload: false
        }
      ],
  ...
  methods: {
    ...
    hideothers(voicetype) {
      for (let index in this.voices) {
        //if(item)
        const item = this.voices[index];
        if (item.voicetype != voicetype) {
          item.isshow = !item.isshow;
          // else break;
          // console.info(item.isshow);
        } else {
    ...
    onchoosetype(voicetype) {
      ...
      if (!this.lastFinish) {
        // alert("正在加载Zzzz");
        this.$message("正在加载Zzzz");
      } else {
        this.hideothers(voicetype);
        if (!this.recordLoad) {
          this.tts();
        }
        if (this.recordLoad) {
